//
//  RBUserFollowersTableViewController.m
...
@interface RBUserFollowersTableViewController ()
...
@implementation RBUserFollowersTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.getCase) {
        ...
        RBUser* follower = [self.followersArray objectAtIndex:indexPath.row];
        ...
        RBUser* subscribers = [self.subscribersArray objectAtIndex:indexPath.row];
