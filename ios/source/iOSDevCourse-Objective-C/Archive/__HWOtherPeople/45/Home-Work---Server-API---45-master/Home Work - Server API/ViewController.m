...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RBUser* friend = [self.friendsArray objectAtIndex:indexPath.row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"userDetail"]) {
        ...
        RBUser* user = [self.friendsArray objectAtIndex:indexPath.row];
        
        RBDetailViewController* vc = [segue destinationViewController];
