...
Урок номер 25. Кнопки. Задание, обсуждение, вопросы.
...
4. Наведите более / менее красоту, можете насоздавать линий (вьюхи с малой шириной) ставить бэкграунды используйте картинки если надо и тд. - проявите творчество :)
...
9. Когда нажимаешь равно то первое число выполняет операцию над вторым и выводится результат
